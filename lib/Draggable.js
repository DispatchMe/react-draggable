...
export default class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  render(): ReactElement<any> {
    ...
    const propPosition = this.props.position || {};
    const defaultPosition = this.props.defaultPosition || {};

    const transformOpts = {
      // Set left if horizontal drag is enabled
      x: propPosition.x || canDragX(this) && draggable ?
        this.state.x : defaultPosition.x,

      // Set top if vertical drag is enabled
      y: propPosition.y || canDragY(this) && draggable ?
        this.state.y : defaultPosition.y
    };
